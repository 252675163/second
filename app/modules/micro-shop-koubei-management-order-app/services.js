...
define(["ionic", "services/net/micro-shop-koubei"], function() {
    return angular.module("MicroShopKoubeiManagementOrderApp.services", ["services.net.microShopKoubei"])
        .service("MicroShopKoubeiManagementOrderAppService", [
            ...
            function($rootScope, microShopKoubeiNetService, promptBarService) {
                ...
                service.getMicroShopOrders = function(pageIndex, pageSize) {
                    return microShopKoubeiNetService.getMicroShopOrders(pageIndex, pageSize);
                }

                //更新订单状态为已完成
                service.updateMicroShopOrderFinish = function(orderId) {
                    return microShopKoubeiNetService.updateMicroShopOrderFinish(orderId);
                }
