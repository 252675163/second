...
define(["ionic"], function () {
    angular.module("Template5_5.directives", [])
        .directive("template5by5", [
            "$window", "$timeout","template5_5Service", "uploadImgService",function ($window, $timeout,template5_5Service,uploadImgService ) {
                return {
                    restrict: 'EA',
                    templateUrl: "components/templates/micro-activity-template/template5_5/template.html",
                    link: function (scope, iElement, iAttr) {
                        ...
                        function init(){
                            if (angular.equals(scope.templateModel, {}) || angular.isUndefined(scope.templateModel)) {
                                scope.sectionModel.templateModel = angular.copy(template5_5Service.model);
