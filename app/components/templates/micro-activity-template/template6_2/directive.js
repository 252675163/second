...
define(["ionic"], function () {
    angular.module("Template6_2.directives", [])
        .directive("template6by2", [
            "$window", "$timeout","template6_2Service", "uploadImgService",function ($window, $timeout,template6_2Service,uploadImgService ) {
                return {
                    restrict: 'EA',
                    templateUrl: "components/templates/micro-activity-template/template6_2/template.html",
                    link: function (scope, iElement, iAttr) {
                        ...
                        function init(){
                            if (angular.equals(scope.templateModel, {}) || angular.isUndefined(scope.templateModel)) {
                                scope.sectionModel.templateModel = angular.copy(template6_2Service.model);
