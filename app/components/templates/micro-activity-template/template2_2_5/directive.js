...
define(["ionic"], function () {
    angular.module("microOldNewTemplate2_2_5.directives", [])
        .directive("microOldNewTemplate225", [
            "$window", "$timeout", "microOldNewTemplate2_2_5Service", "uploadImgService", function ($window, $timeout, microOldNewTemplate2_2_5Service, uploadImgService) {
                return {
                    restrict: 'EA',
                    templateUrl: "components/templates/micro-activity-template/template2_2_5/template2_2_5.html",
                    link: function (scope, iElement, iAttr) {
                        ...
                        function init(){
                            if (angular.equals(scope.templateModel, {}) || angular.isUndefined(scope.templateModel)) {
                                scope.sectionModel.templateModel = angular.copy(microOldNewTemplate2_2_5Service.model);
