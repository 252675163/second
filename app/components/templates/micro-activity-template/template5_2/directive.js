...
define(["ionic"], function () {
    angular.module("Template5_2.directives", [])
        .directive("template5by2", [
            "$window", "$timeout","template5_2Service", "uploadImgService",function ($window, $timeout,template5_2Service,uploadImgService ) {
                return {
                    restrict: 'EA',
                    templateUrl: "components/templates/micro-activity-template/template5_2/template.html",
                    link: function (scope, iElement, iAttr) {
                        ...
                        function init(){
                            if (angular.equals(scope.templateModel, {}) || angular.isUndefined(scope.templateModel)) {
                                scope.sectionModel.templateModel = angular.copy(template5_2Service.model);
