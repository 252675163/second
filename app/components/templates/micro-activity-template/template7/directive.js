...
define(["ionic"], function () {
    angular.module("Template7.directives", [])
        .directive("template7", [
            "$window", "$timeout", "template7Service", "uploadImgService", function ($window, $timeout, template7Service, uploadImgService) {
                return {
                    restrict: 'EA',
                    templateUrl: "components/templates/micro-activity-template/template7/template.html",
                    link: function (scope, iElement, iAttr) {
                        ...
                        function init(){
                            if (angular.equals(scope.templateModel, {}) || angular.isUndefined(scope.templateModel)) {
                                scope.sectionModel.templateModel = angular.copy(template7Service.model);
                        ...
                        scope.updateImg = function (imgIndex) {
                            ...
                            uploadImgService.upLoadImg(template7Service.getConfigByAspectRatio(scope.imgAspectRatio[imgIndex]), 1, scope.upLoadFinish);
                        };
