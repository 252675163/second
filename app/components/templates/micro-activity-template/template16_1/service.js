...
define(['ionic','services/net/activity-view'], function () {
    return angular.module('Template16_1.Service', ['services.net.activityView']).
        factory('template16_1Service', ['activityFormService','activityViewNetService', function (activityFormService,activityViewNetService) {

            var service = {};
            service.model =
            {
                title: "读趣乐教育",
                description: "前50报名成功者，即可尊享课程8.8折优惠",
                submitName: "马上报名",
                imageUrl: [window.resourceDoMain + '/app/img/acty23_logo_3.jpg']
            };
