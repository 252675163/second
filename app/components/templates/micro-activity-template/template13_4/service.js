...
define(["ionic", "services/net/activity-template"], function() {
    return angular.module("Template13_4.Service", ["services.net.activityTemplate"]).
        factory("template13_4Service", [
            "$http", "activityFormService", "activityTemplateService", function($http, activityFormService, activityTemplateService) {
                ...
                service.getGrassUserInfosByPage = function (id, userType, pageIndex) {
                    //是否是第一次分享出来的页面
                    var isFirstShare = userType == "old" ? true : false;
                    return activityTemplateService.getGrassUserInfosByPage(id, isFirstShare, pageIndex);
                };
