...
define(["ionic"], function () {
    angular.module("Template5_3.directives", [])
        .directive("template5by3", [
            "$window", "$timeout","template5_3Service", "uploadImgService",function ($window, $timeout,template5_3Service,uploadImgService ) {
                return {
                    restrict: 'EA',
                    templateUrl: "components/templates/micro-activity-template/template5_3/template.html",
                    link: function (scope, iElement, iAttr) {
                        ...
                        function init(){
                            if (angular.equals(scope.templateModel, {}) || angular.isUndefined(scope.templateModel)) {
                                scope.sectionModel.templateModel = angular.copy(template5_3Service.model);
