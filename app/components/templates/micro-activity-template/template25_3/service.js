...
define(['ionic','services/net/activity-view'], function () {
    return angular.module('Template25_3.Service', ['services.net.activityView']).
        factory('template25_3Service', ['activityFormService','activityViewNetService', function (activityFormService,activityViewNetService) {

            var service = {};
            service.model =
            {  
                title: "传单报名页",
                description: "即刻报名申请免费试听",
                imageUrl: [""]
            };
