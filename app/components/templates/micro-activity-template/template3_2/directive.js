...
define(["ionic"], function () {
    angular.module("Template3_2.directives", [])
        .directive("template3by2", [
            "$window", "$timeout","template3_2Service", "uploadImgService",function ($window, $timeout,template3_2Service,uploadImgService ) {
                return {
                    restrict: 'EA',
                    templateUrl: "components/templates/micro-activity-template/template3_2/template.html",
                    link: function (scope, iElement, iAttr) {
                        ...
                        function init(){
                            if (angular.equals(scope.templateModel, {}) || angular.isUndefined(scope.templateModel)) {
                                scope.sectionModel.templateModel = angular.copy(template3_2Service.model);
