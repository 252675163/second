...
define(["ionic"], function () {
    angular.module("microOldNewTemplate2_2_3.directives", [])
        .directive("microOldNewTemplate223", [
            "$window", "$timeout", "microOldNewTemplate2_2_3Service", "uploadImgService", function ($window, $timeout, microOldNewTemplate2_2_3Service, uploadImgService) {
                return {
                    restrict: 'EA',
                    templateUrl: "components/templates/micro-activity-template/template2_2_3/template2_2_3.html",
                    link: function (scope, iElement, iAttr) {
                        ...
                        function init(){
                            if (angular.equals(scope.templateModel, {}) || angular.isUndefined(scope.templateModel)) {
                                scope.sectionModel.templateModel = angular.copy(microOldNewTemplate2_2_3Service.model);
