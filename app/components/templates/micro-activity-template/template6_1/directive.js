...
define(["ionic"], function () {
    angular.module("Template6_1.directives", [])
        .directive("template6by1", [
            "$window", "$timeout","template6_1Service", "uploadImgService",function ($window, $timeout,template6_1Service,uploadImgService ) {
                return {
                    restrict: 'EA',
                    templateUrl: "components/templates/micro-activity-template/template6_1/template.html",
                    link: function (scope, iElement, iAttr) {
                        ...
                        function init(){
                            if (angular.equals(scope.templateModel, {}) || angular.isUndefined(scope.templateModel)) {
                                scope.sectionModel.templateModel = angular.copy(template6_1Service.model);
