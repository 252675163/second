...
define(['ionic','services/net/activity-view'], function () {
    return angular.module('Template17_2.Service', ['services.net.activityView']).
        factory('template17_2Service', ['activityFormService','activityViewNetService', function (activityFormService,activityViewNetService) {

            var service = {};
            service.model =
            {
                title: "立即报名",
                description: "长按/扫描二维码关注我们的公众号，更多惊喜等你喔~名额有限~快报名吧！",
                submitName: "马上报名",
