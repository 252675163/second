...
define(['ionic','services/net/activity-view'], function () {
    return angular.module('MicroLeaflet4_3.Service', ['services.net.activityView']).
        factory('microLeaflet4_3Service', ['activityFormService','activityViewNetService', function (activityFormService,activityViewNetService) {

            var service = {};
            service.model =
            {  
                title: "传单报名页",
                description: "即刻报名申请免费试课",
                imageUrl: [""]
            };
