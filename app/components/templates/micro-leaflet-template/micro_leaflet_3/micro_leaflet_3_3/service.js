...
define(['ionic','services/net/activity-view'], function () {
    return angular.module('MicroLeaflet3_3.Service', ['services.net.activityView']).
        factory('microLeaflet3_3Service', ['activityFormService','activityViewNetService', function (activityFormService,activityViewNetService) {
