...
define(['ionic','services/net/activity-view'], function () {
    return angular.module('MicroLeaflet5_3.Service', ['services.net.activityView']).
        factory('microLeaflet5_3Service', ['activityFormService','activityViewNetService', function (activityFormService,activityViewNetService) {
